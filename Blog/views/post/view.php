	...
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
					<div class="post">
						<h2 class="title"><a href='/post/<?php echo $postItem['id'] ;?>'><?php echo $postItem['title'].' # '.$postItem['id'];?></a></h2>
						<p class="meta">Posted by <a href="#"><?php echo $postItem['FirstName'] . " " . $postItem['LastName']; ?></a> on <?php echo $postItem['date'];?>
							&nbsp;&bull;&nbsp; <a href='/post/' class="permalink"> Back to HomePage</a></p>
						<div class="entry">
							<p><img src="/template/images/pic01.jpg" width="800" height="300" alt="" /></p>
							<p><?php echo $postItem['content'];?></p>
						</div>
					</div>
					<p><a href='/post/' class="permalink"> Back to HomePage</a></p>
