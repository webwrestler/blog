			...
			<div id="page-bgbtm">
				<div id="content">
					...
					<div class="post">
						...
						<p class="meta">Posted by <a href="#"><?php echo $postItem['Author']?></a> on <?php echo $postItem['date'];?>
							&nbsp;&bull;&nbsp; <a href='/post/<?php echo $postItem['id'] ;?>' class="permalink"> Full article</a></p>
						<div class="entry">
